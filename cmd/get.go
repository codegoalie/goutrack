...
var getCmd = &cobra.Command{
	Use:   "get",
	Short: "Get the details of an issue by ID",
	Long: `Fetches extra details for the issue with the provided ID. For example:
	
goutrack get pr-1234`,
