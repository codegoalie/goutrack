...
var filename = "/Users/chrismar035/workspace/go/src/github.com/codegoalie/goutrack/story.xml"
...
func handleFeed(se xml.StartElement, decoder *xml.Decoder, outFlag *bool) {
	if outFlag == &countAll {
		incrementCounter(se.Name.Space, se.Name.Local)
                ...
                if !oneLevelDown{
        		if se.Name.Local == "issue" && se.Name.Space == "" {
	        	      var item Chiissue
        		...
        		if se.Name.Local == "field" && se.Name.Space == "" {
	        	      var item Chifield
			      decoder.DecodeElement(&item, &se)
			      switch outFlag {
			      case &toJson:
...
type Chicolor struct {
	Chibg *Chibg `xml:" bg,omitempty" json:"bg,omitempty"`
	Chifg *Chifg `xml:" fg,omitempty" json:"fg,omitempty"`
}
...
type Chifield struct {
	...
	Chicolor *Chicolor `xml:" color,omitempty" json:"color,omitempty"`
	Chivalue *Chivalue `xml:" value,omitempty" json:"value,omitempty"`
	ChivalueId *ChivalueId `xml:" valueId,omitempty" json:"valueId,omitempty"`
}

type Chiissue struct {
	Attr_entityId string `xml:" entityId,attr"  json:",omitempty"`
	Attr_id string `xml:" id,attr"  json:",omitempty"`
	Chifield []*Chifield `xml:" field,omitempty" json:"field,omitempty"`
}
